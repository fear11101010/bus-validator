...
import static com.decard.exampleSrc.desfire.util.Utils.printData;
...
import com.decard.exampleSrc.desfire.util.Cryptography;
...
public class DesfireMainActivity extends AppCompatActivity  {

    private static final String TAG = DesfireMainActivity.class.getSimpleName();
    ...
    private TextInputEditText applicationSelected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desfire_main);
        ...
        btnDiscover.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                 ...
                 if (p18QDesfireEV.discoverEVCard()) {
                     ...
                     writeToUiAppendBorderColor(errorCode, errorCodeLayout,"FAILURE - could not found DesfireEV card, aborted", COLOR_RED);
                 }
             }
         });
        ...
        fileRecordRead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (result == null) {
                    ...
                    // split the records
                    List<byte[]> recordList = Utils.divideArrayToList(result, selectedFileSettings.getRecordSizeInt());
...
*/
        ...
        getTagUid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //desfireEv3.authenticateAesEv2First(Constants.APPLICATION_KEY_MASTER_NUMBER, Constants.APPLICATION_KEY_MASTER_AES_DEFAULT);
        ...
        formatPicc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DesfireMainActivity.this);
        ...
        test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                byte[] result = desfireEv3.getKeyEV3Settings();
                ...
                //boolean success;
                stepString = "1 select Master Application";
                ...
                success = desfireEv3.changeAesKeyToDes(Constants.MASTER_APPLICATION_KEY_NUMBER, Constants.MASTER_APPLICATION_KEY_NUMBER, Constants.MASTER_APPLICATION_KEY_DES_DEFAULT, Constants.MASTER_APPLICATION_KEY_AES_DEFAULT, "Master App Key");
    ...
    private void showDialogWarningCommitReaderId() {
        ...
        showDialog(DesfireMainActivity.this, tmacWarningMessage);
    }
    ...
    private void showDialogWarningDesfireEv1() {
        ...
        showDialog(DesfireMainActivity.this, desfireEv1WarningMessage);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mFormatPicc.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(DesfireMainActivity.this, FormatPiccActivity.class);
        ...
        mSetupTestEnvironment.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(DesfireMainActivity.this, SetupTestEnvironmentActivity.class);
                startActivity(intent);
                return false;
            }
        });
        ...
        mPersonalize.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(DesfireMainActivity.this, PersonalizeActivity.class);
                startActivity(intent);
                return false;
            }
        });
        ...
        mCreateApplication.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(DesfireMainActivity.this, CreateApplicationActivity.class);
                startActivity(intent);
                return false;
            }
        });
        ...
        mCreateFile.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(DesfireMainActivity.this, CreateFileActivity.class);
                startActivity(intent);
                return false;
            }
        });
        ...
        mSetupLightEnvironment.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(DesfireMainActivity.this, SetupLightEnvironmentActivity.class);
                startActivity(intent);
                return false;
            }
        });
        ...
        mDesFireMain.setEnabled(false);

        MenuItem mGoToHome = menu.findItem(R.id.action_return_main);
        mGoToHome.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                Intent intent = new Intent(DesfireMainActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
                return false;
            }
